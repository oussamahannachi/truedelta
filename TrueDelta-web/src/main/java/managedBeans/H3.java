...
public class H3 implements Serializable {
	...
	private List<ActifFinancier> actifsv ;
	@EJB
...
public void doafficher() {
	...
	public List<ActifFinancier> getActifsv() {
		actifsv = ts.consulterActifsv();
		return actifsv;
	}


	public void setActifsv(List<ActifFinancier> actifsv) {
		this.actifsv = actifsv;
	}
