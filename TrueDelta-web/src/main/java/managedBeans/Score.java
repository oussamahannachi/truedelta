...
public class Score implements Serializable {
	...
	private List<Transaction> transactionssnv;
...
public void doafficher() {
	...
	public List<Transaction> getTransactions() {
		transactions = ts.classerTransactionNonScoré();
		return transactions;
	}
	...
	public List<Transaction> getTransactionsv() {
		transactionsv=ts.classerTransactionNonScoré();
	...
	public List<Transaction> getTransactionssnv() {
		transactionssnv=ts.classerTransactionScoré();
		return transactionssnv;
	}


	public void setTransactionssnv(List<Transaction> transactionssnv) {
		this.transactionssnv = transactionssnv;
	}
	public String transactionscore() {
		Transaction trans = ts.getTransactionById(id);
		ts.Scooringtransaction(id);
