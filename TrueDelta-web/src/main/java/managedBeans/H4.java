...
public class H4 implements Serializable {
	...
	private List<ActifFinancier> actifsnv ;
	@EJB
...
public void doafficher() {
	...
	public List<ActifFinancier> getActifsnv() {
		actifsnv = ts.consulterActifsnv();
		return actifsnv;
	}


	public void setActifsnv(List<ActifFinancier> actifsnv) {
		this.actifsnv = actifsnv;
	}
