...
private List<String> devises = Arrays.asList("euro", "dollar", "dinar");
@EJB
...
public void displayTransactionV(Transaction trans)
{if(trans.getIsValide()==true) {
...
public void displayTransactionNV(Transaction trans)
{if(trans.getIsValide()==false) {
this.setId(trans.getId());
this.setDate(trans.getDate());
this.setIsValide(trans.getIsValide());
this.setType(trans.getType());
...
public void displayTransactionParCompte(Transaction trans,long numc)
{if(trans.getNumcompte()==numc && trans.getIsValide()==true) {
this.setId(trans.getId());
this.setDate(trans.getDate());
this.setIsValide(trans.getIsValide());
this.setType(trans.getType());
...
public void displayANV(ActifFinancier a)
{if(a.getCompte()==null) {
this.setId(a.getId());
this.setCompte(a.getCompte());
this.setCurrency(a.getCurrency());
this.setDateEcheance(a.getDateEcheance());
this.setEntreprise(a.getEntreprise());
this.setInteret(a.getInteret());
this.setRendement(a.getRendement());
this.setRisque(a.getRisque());
this.setTransaction(a.getTransaction());
this.setTypea(a.getType());
