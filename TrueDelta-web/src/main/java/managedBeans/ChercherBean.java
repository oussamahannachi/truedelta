...
@ManagedBean(name= "ch")
@SessionScoped
public class ChercherBean implements Serializable {
...
public String dochercher()
{
	String navigateTo = "null"; 
	transaction = ts.getTransactionById(id) ;

	if (transaction != null ) {
		navigateTo ="../pages/affiche?faces-redirect=true";
		loggedIn = true; 
	}
	else 
	{
