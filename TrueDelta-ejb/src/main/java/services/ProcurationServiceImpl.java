...
public class ProcurationServiceImpl implements ProcurationServiceRemote {
	...
	public void AjouterContrat(int num,Client c) throws MalformedURLException, IOException, DocumentException {
		...
		PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\OUSSAMA HANNACHI\\Documents\\Eclipse-Workspace\\truedelta-master\\TrueDelta-ejb\\src\\main\\java\\Files"+ username + p.getNumero() + ".pdf"));
		...
		String url = "C:\\Users\\OUSSAMA HANNACHI\\Documents\\Eclipse-Workspace\\truedelta-master\\TrueDelta-ejb\\src\\main\\java\\Files\\Tempon.png";
